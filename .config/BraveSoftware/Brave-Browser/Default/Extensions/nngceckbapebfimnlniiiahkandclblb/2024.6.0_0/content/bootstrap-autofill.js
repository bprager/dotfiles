...
class CollectAutofillContentService {
    constructor(domElementVisibilityService, autofillOverlayContentService) {
        ...
        this.useTreeWalkerStrategyFlagSet = false;
        /**
        ...
        void sendExtensionMessage("getUseTreeWalkerApiForPageDetailsCollectionFeatureFlag").then((useTreeWalkerStrategyFlag) => (this.useTreeWalkerStrategyFlagSet = !!(useTreeWalkerStrategyFlag === null || useTreeWalkerStrategyFlag === void 0 ? void 0 : useTreeWalkerStrategyFlag.result)));
    }
    /**
